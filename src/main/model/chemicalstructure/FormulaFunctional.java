...
public class FormulaFunctional {
    ...
    public FormulaFunctional(String unparsedFormula) {
    ...
    private MoleculeGroup processSubstitutableGroup(String group) throws UnknownElementException {
        ...
        return processSubGroup(group, substitutableMoleculeList);
    }
    ...
    private MoleculeGroup processCovalentIon(String group) throws UnknownElementException {
        ...
        return processSubGroup(group, covalentMoleculeList);
    }
    ...
    private MoleculeGroup processSubGroup(String group, List<FormulaElement> toAdd) throws UnknownElementException {
        int amount;
        ...
        String justElements = group.replaceAll(bracketDigit.toString(), "").replaceAll("[^A-Za-z\\d]", "");
